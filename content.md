...
- Важное для понимания в JavaScript (высокоуровнево как работает)
  ...
  - Замыкания, область видимости, LexicalEncvironment.
    - Замыкания
      - Глобальный объект
      ...
      - Лексическое окружение(LexicalEncvironment)
    ...
    - Бонус. Разница между FunctionDeclaration и FunctionExpression. Поднятие(Hoisting). (из понимания LexicalEnvironment)
